...
//        this.setLocation(size.width/2-getWidth()/2,size.height/3-getHeight()/2);
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(0, 105, 146));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        jPanel1.add(loginJLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(124, 229, -1, -1));

        jLabel1.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 28)); // NOI18N
        jLabel1.setText("FOOD DELIVERY MANAGEMENT SYSTEM");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 13, -1, 26));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-macos-close-32.png"))); // NOI18N
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 0, 40, 40));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 0, 40, 40));

        jSplitPane1.setLeftComponent(jPanel1);

        container.setBackground(new java.awt.Color(0, 105, 146));
